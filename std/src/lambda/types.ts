...
export type Head<T extends any[]> = T extends [infer F, ...infer I] ? F : T extends [(infer F)?, ...infer I] ? F | undefined : never
...
export type Last<T extends any[]> = T extends [...infer I, infer L] ? L : T extends [...infer I, (infer L)?] ? L | undefined : never
