import { keys, Option } from "@arhnage/std";
...
export interface Get {
	<S extends Put<K, unknown>, K extends keys>(source: S): (prism: Prism<K>) => Option<Pull<S, K>>;
	<S extends Put<K, unknown>, K extends keys>(prism: Prism<K>, source: S): Option<Pull<S, K>>;
}

export interface Set {
	<S extends Put<K, unknown>, K extends keys>(source: S, value: Pull<S, K>): (prism: Prism<K>) => S;
	<S extends Put<K, unknown>, K extends keys>(prism: Prism<K>, source: S, value: Pull<S, K>): S;
}

export interface Over {
	<S extends Put<K, unknown>, K extends keys>(source: S, lambda: (value: Pull<S, K>) => Pull<S, K>): (prism: Prism<K>) => S;
	<S extends Put<K, unknown>, K extends keys>(prism: Prism<K>, source: S, lambda: (value: Pull<S, K>) => Pull<S, K>): S;
}
