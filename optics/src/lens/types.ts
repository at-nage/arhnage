...
export interface Set {
	<S extends Put<K, unknown>, K extends keys>(source: S, value: Pull<S, K>): (lens: Lens<keys>) => S;
	<S extends Put<K, unknown>, K extends keys>(lens: Lens<K>, source: S, value: Pull<S, K>): S
}

export interface Over {
	<S extends Put<K, unknown>, K extends keys>(source: S, lambda: (value: Pull<S, K>) => Pull<S, K>): (lens: Lens<keys>) => S;
	<S extends Put<K, unknown>, K extends keys>(lens: Lens<K>, source: S, lambda: (value: Pull<S, K>) => Pull<S, K>): S
}
